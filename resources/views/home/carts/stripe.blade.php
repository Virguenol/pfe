...
<div class="container" style="padding-top:50px">
    ...
    <h1 style="text-align: center; padding:10px; font-size:30px">Payer avec votre panier - Total ${{$totalprice}}</h1>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    <h1 style="text-align: center; padding:2px; font-size:20px">Payez avec votre carte</h1>

<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{url('/view_post')}}">Ajouter un poste</a></li>
            <li class="nav-item"> <a class="nav-link" href="{{url('/index_post')}}">Afficher les postes</a></li>
          </ul>
        </div>
      </li>
    </ul>
